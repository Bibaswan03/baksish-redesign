  ...
  return (
    <>
      ...
      <div className="w-[90%] mx-auto mt-10 p-4 border rounded-lg shadow-lg lg:w-[70%] h-[70%] bg-white">
        <h1 className="text-xl sm:text-2xl font-bold mb-4">Terms of Service</h1>
        <div className="h-[25rem] hover:cursor-pointer overflow-y-auto pr-4">
          ...
          <p className="text-sm sm:text-base mb-4">
            If you have any questions about these terms, please contact us at <a href="mailto:baksish247@gmail.com" className="underline text-[#441029]">baksish247@gmail.com</a>.
          </p>
