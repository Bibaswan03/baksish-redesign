    ...
    <Header/>
      <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
        <div className="bg-white  rounded-lg shadow-lg max-w-3xl w-full">
          <div
            className="bg-[#661268] text-[#FFF9EA] p-8"
          >
            <h1 className="text-2xl font-bold mb-4">
              Baksish - Terms and Conditions
            </h1>
          ...
          <p className="text-gray-600 mb-4">
            By accessing or using Baksish, you agree to be bound by these terms.
          ...
          <p className="text-gray-600 mb-4">
            Baksish provides a platform for hotel waiters to receive tips from
            customers through online payments like UPI and cards.
          </p>
          ...
          <p className="text-gray-600 mb-4">
            All payments made through Baksish are processed via third-party
            payment gateways. We do not store any payment information. You agree
            to comply with all applicable laws and regulations related to your
          ...
          <p className="text-gray-600 mb-4">
            In no event shall Baksish, nor its directors, employees, partners,
          ...
          <p className="text-gray-600 mb-4">
            ...
            If a revision is material, we will try to provide at least 14 days'
          ...
          <p className="text-gray-600">
            ...
            <a href="mailto:baksish247@gmail.com" className="hover:underline">
